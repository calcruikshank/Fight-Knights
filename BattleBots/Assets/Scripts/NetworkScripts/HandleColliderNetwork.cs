...
public class HandleColliderNetwork : MonoBehaviour
{
    public NetworkPlayerController player;
    NetworkPlayerController opponent;
    NetworkPlayerController opponentHit;
    ...
    public void SetPlayer(NetworkPlayerController player, Transform handSent)
    {

        this.player = player;
    }

    public void HandleCollision(float hitId, float damage, NetworkPlayerController sentOpponent)
    {
