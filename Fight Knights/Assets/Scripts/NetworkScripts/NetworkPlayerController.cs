...
public class NetworkPlayerController : NetworkBehaviour
{
    ...
    public int stocks = 4;
    protected NetworkPlayerController opponent;
    ...
    private IEnumerator GrabTimer(float grabtime)
    {
        ...
        {
            Destroy(swirlInstantiated.gameObject);
        }
        animatorUpdated.SetBool("Grabbing", false);
    }
    ...
    public virtual void Knockback(float damage, Vector3 direction, NetworkPlayerController playerSent)
    {
        if (grabbing)
        {
            EndGrab();
    ...
    public void Grab(NetworkPlayerController opponent, Transform grabbedTransform)
    {
    ...
    {
        GameObject leftJab = Instantiate(leftJabParticle, dir, Quaternion.identity);
        leftJab.transform.right = rot;
        HandleColliderNetwork handleCollider = leftJab.GetComponent<HandleColliderNetwork>();
    ...
    {
        GameObject splatter = Instantiate(splatterPrefab, dir, Quaternion.identity);
        splatter.transform.right = rot;
